...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2025 at 08:51 PM
...
CREATE TABLE `peminjaman` (
  ...
  `CekData` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `peminjaman` (`id_peminjaman`, `id_pengunjung`, `id_staff`, `nomor_isbn`, `tanggal_pinjam`, `tanggal_kembali`, `status_peminjaman`, `CekData`) VALUES
(1, 101, 2303, 10416882, '2024-12-30', '2025-01-10', 'Belum Kembali', 'Belum Terverifikasi'),
(2, 102, 2303, 10345600, '2024-12-10', '2024-12-15', 'Kembali', 'Terverifikasi'),
(3, 103, 23019, 11955409, '2024-12-10', '2024-12-15', 'Kembali', 'Terverifikasi'),
(4, 104, 2303, 10920946, '2024-11-30', '2024-12-10', 'Kembali', 'Terverifikasi'),
(5, 105, 23019, 11143256, '2024-10-25', '2024-11-05', 'Kembali', 'Terverifikasi'),
(6, 106, 23019, 10723001, '2024-10-22', '2024-11-02', 'Kembali', 'Terverifikasi'),
(7, 107, 2303, 12031005, '2024-10-05', '2024-10-20', 'Kembali', 'Terverifikasi'),
(8, 108, 2303, 11735044, '2024-10-05', '2024-10-20', 'Kembali', 'Terverifikasi'),
(9, 109, 23019, 11483412, '2024-09-30', '2024-10-10', 'Kembali', 'Terverifikasi'),
(10, 110, 23019, 11276644, '2024-09-30', '2024-10-30', 'Kembali', 'Terverifikasi'),
(11, 111, 23019, 11812404, '2024-09-30', '2024-10-10', 'Kembali', 'Terverifikasi'),
(12, 112, 23019, 11627225, '2024-09-30', '2024-10-10', 'Kembali', 'Terverifikasi'),
(13, 113, 2303, 10568943, '2024-09-20', '2024-09-30', 'Kembali', 'Terverifikasi'),
(14, 114, 2303, 10693506, '2024-09-20', '2024-09-30', 'Kembali', 'Terverifikasi'),
(15, 115, 2303, 10123456, '2024-09-20', '2024-09-30', 'Kembali', 'Terverifikasi'),
(16, 116, 2303, 10893062, '2024-09-20', '2024-09-30', 'Kembali', 'Terverifikasi'),
(17, 117, 2303, 11538411, '2024-09-20', '2024-09-30', 'Kembali', 'Terverifikasi'),
(18, 118, 2303, 11376867, '2024-08-30', '2024-09-10', 'Kembali', 'Terverifikasi'),
(19, 119, 23019, 11098092, '2024-08-30', '2024-09-10', 'Kembali', 'Terverifikasi'),
(20, 120, 23019, 10294310, '2024-08-30', '2024-09-10', 'Kembali', 'Terverifikasi');
